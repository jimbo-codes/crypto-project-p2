...
const features = [
  {
    name: 'Developer Data',
    description: "There's no better indication if a protocol is being pushed forward. Track all notable changes automatically",
    icon: TerminalIcon,
  },
  {
    name: 'Examine Social Data',
    description: "wouldn't it be great to know about the next hot project before it jumps? Monitoring social activity lets you do exactly that.",
    icon: UsersIcon,
  },
  {
  ...
  {
    name: 'Top Movers',
    description: "Stop wasting time looking for daily top movers. See them front and center on our dashboard.",
    icon: TrendingUpIcon,
  },
]

const metrics = [
  { id: 1, stat: '2+', emphasis: 'People', rest: 'Using this dashboard' },
  { id: 2, stat: '1+', emphasis: 'Countries', rest: '' },
  { id: 3, stat: '98%', emphasis: 'Customer satisfaction', rest: 'As measured by one internal survey' },
  { id: 4, stat: '1M+', emphasis: 'Issues resolved', rest: 'While this might not be true, it certainly feels true.' },
]
...
return(
    <div className="bg-white">
            ...
            <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
              ...
              <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                <h1 className="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                  ...
                  <span className="block text-indigo-200">Your Dad's Market</span>
                </h1>
                <p className="mt-6 max-w-lg mx-auto text-center text-xl text-indigo-200 sm:max-w-3xl">
                  Blockchain technology is here to stay, but the market is volatile. Without cross validated informational alpha, uninformed traders remain vulnerable to price swings.
                </p>
                <div className="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
                  <div className="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-1 sm:gap-5">
                    ...
                    <Link to='/user' onClick={handleClickHome}
        ...
        <div className="bg-gray-100">
          <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
            <p className="text-center text-sm font-semibold uppercase text-gray-500 tracking-wide">
              Believe it or not, we're already trusted by over 5 made up very average small businesses
            </p>
          ...
          <div className="h-80 absolute inset-x-0 bottom-0 xl:top-0 xl:h-full">
            <div className="h-full w-full xl:grid xl:grid-cols-2">
              <div className="h-full xl:relative xl:col-start-2">
                ...
                //   Figure out an image to put here.
      ...
      <footer className="bg-gray-50" aria-labelledby="footer-heading">
        ...
        <div className="content-center mx-auto pt-16 pb-8 px-4 sm:px-6 lg:pt-24 lg:px-8">
            <div className="mx-auto mt-12 grid place-items-center xl:mt-0">
              <h3 className="text-sm font-semibold text-gray-400 tracking-wider uppercase">
                Subscribe for Updates
              </h3>
              <p className="mt-4 text-base text-gray-500">
                We *will* resell your information. Nothing in life is free.
              </p>
          ...
          <div className="mt-12 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between lg:mt-16">
            ...
            <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
              &copy; 2021 Fairly II, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
